...
**IMPORTANT**: The library's import path is based on its original location under `github.com/uber`. Do not try to import it as `github.com/jaegertracing`, it will not compile. We might revisit this in the next major release.
  * :white_check_mark: `import "github.com/johngray/jaeger-client-go"`
...
```yaml
- package: github.com/johngray/jaeger-client-go
  version: ^2.7.0
```
...
```shell
go get -u github.com/johngray/jaeger-client-go/
cd $GOPATH/src/github.com/johngray/jaeger-client-go/
...
See tracer initialization examples in [godoc](https://godoc.org/github.com/johngray/jaeger-client-go/config#pkg-examples)
...
[doc-img]: https://godoc.org/github.com/johngray/jaeger-client-go?status.svg
[doc]: https://godoc.org/github.com/johngray/jaeger-client-go
